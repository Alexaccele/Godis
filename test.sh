...
#tcp test#
if [ "$1" == 'tcp' ]; then
  ./cache-benchmark.bak -type tcp -n 100000 -r 100000 -t set -c 4
  ./cache-benchmark.bak -type tcp -n 100000 -r 100000 -t get -c 4
elif [ "$1" == 'http' ]; then
#http test#
  ./cache-benchmark.bak -type http -p 9090 -n 100000 -r 100000 -t set
  ./cache-benchmark.bak -type http -p 9090 -n 100000 -r 100000 -t get
fi
redis-benchmark -c 4 -n 100000 -d 1000 -t set,get -r 100000
